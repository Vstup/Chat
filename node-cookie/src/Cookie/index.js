 ...
 * @private
 */
Cookie._signValue = function (value, secret) {
secret = secret || null;
if (!secret) {
    return value
  }
 ...
 * @private
 */
Cookie._unSignValue = function (value, secret) {
secret = secret || null;  
value = String(value)
  /**
 ...
 * ```
 */
Cookie.get = function (req, key, secret, decrypt, cookies) {
secret = secret || null;
decrypt = decrypt || false;
 ...
 * ```
 */
Cookie.create = function (res, key, value, options, secret, encrypt) {
secret = secret || null;
